...
class DualNetHDModel(BaseModel):
    def name(self):
        return 'DualNetHDModel'
    ...
    def initialize(self, opt):
        ...
        self.loss_names = ['G_L1', 'G_L1_B', 'G_CX', 'G_CX_B', 'G_GAN', 'G_GAN_B', 'D', 'D_B',
                           'G_L1_val', 'G_L1_B_val', 'local_adv', 'local_adv_B']
        ...
        self.model_names = ['G']
        # TODO: dualnet plus model (unsupervised)
        '''
        A content -    -> shape   fake_B  ->  fake_B_hd
                  | ->  |                  |
        Cs style   -    -> texture fake_C  ->  fake_C_hd
        '''
        # self.netG_hd = networks.define_G_hd()
    ...
    def backward_G(self):
        ...
        self.loss_G = self.loss_G_GAN + self.loss_G_GAN_B \
            ...
            + self.loss_local_adv + self.loss_local_adv_B
